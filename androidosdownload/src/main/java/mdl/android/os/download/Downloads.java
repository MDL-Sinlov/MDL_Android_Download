...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "mdl.android.os.download.downloads";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "mdl.android.os.download.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "mdl.android.os.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "mdl.android.os.download.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "mdl.android.os.download.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "mdl.android.os.download.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * mdl.android.os.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED.
     * <P>
     * Type: INTEGER
     * </P>
     * <P>
